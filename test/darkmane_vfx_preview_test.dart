...
// DARKMANE_VFX_OUT=/tmp flutter test test/darkmane_vfx_preview_test.dart
// Render the actual shared special at multiple camera scales and at expiry.
void main() {
  final output = Platform.environment['DARKMANE_VFX_OUT'];
  testWidgets('Darkmane material and fade preview', (tester) async {
    ...
    label('DARKMANE / shared in-game renderer', 24, 18, size: 21);
    ...
    label('flight / inward pull', 120, 535);
    label('expiry / void collapse', 730, 535);
    ...
    await tester.runAsync(() async {
      ...
      File(
        '$output/darkmane_vfx_preview.png',
      ).writeAsBytesSync(bytes!.buffer.asUint8List());
      image.dispose();
    });
    picture.dispose();
  }, skip: output == null);
  testWidgets('Darkmane motion preview', (tester) async {
    final frames = Directory('$output/darkmane_frames')
  ...
  }, skip: output == null || Platform.environment['DARKMANE_MOTION'] != '1');
}
