...
void main() {
  ...
  test('the authored trio can earn all three Fire stars end-to-end', () {
    ...
    for (final bed in _room(game, 'cloister').vineBeds) {
      game.setActive(2);
