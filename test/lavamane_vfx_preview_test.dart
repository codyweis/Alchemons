...
// LAVAMANE_VFX_OUT=/tmp flutter test test/lavamane_vfx_preview_test.dart
// Render the actual shared special at multiple camera scales and at expiry.
void main() {
  final output = Platform.environment['LAVAMANE_VFX_OUT'];
  testWidgets('Lavamane material and fade preview', (tester) async {
    ...
    label('LAVAMANE / shared in-game renderer', 24, 18, size: 21);
    ...
    label('flight / molten droplets', 120, 535);
    label('expiry / cooling fade', 730, 535);
    ...
    await tester.runAsync(() async {
      ...
      File(
        '$output/lavamane_vfx_preview.png',
      ).writeAsBytesSync(bytes!.buffer.asUint8List());
      image.dispose();
    });
    picture.dispose();
  }, skip: output == null);
  testWidgets('Lavamane motion preview', (tester) async {
    final frames = Directory('$output/lavamane_frames')
  ...
  }, skip: output == null || Platform.environment['LAVAMANE_MOTION'] != '1');
}
