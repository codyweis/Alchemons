                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              if (currentInstance.natureId != null &&
                                  currentInstance.natureId!.isNotEmpty)
                                _TraitPill(
                                  label: currentInstance.natureId!
                                      .toUpperCase(),
                                  color: t.amberBright,
                                ),
                              if (currentInstance.natureId2 != null &&
                                  currentInstance.natureId2!.isNotEmpty)
                                _TraitPill(
                                  label: currentInstance.natureId2!
                                      .toUpperCase(),
                                  color: t.amberBright,
                                ),
                            ],
...
class _QuickStatBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final potentialFill = potential != null
        ? AlchemonStatSystem.normalizePotential(potential!) / 100.0
        : null;
      ...
      children: [
        ...
        SizedBox(
          ...
          child: Text(
            potential == null
                ? '$rating'
                : '$rating · P${AlchemonStatSystem.normalizePotential(potential!)}',
