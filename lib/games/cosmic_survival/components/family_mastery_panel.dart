...
const Map<String, IconData> kFamilyMasteryNodeIcons = {
  ...
  'mane.control.sweeping_claws': PhosphorIconsBold.waves,
  'mane.control.rending_wake': PhosphorIconsBold.flame,
  'mane.control.crosswind': PhosphorIconsBold.wind,
  'mane.control.tempest_ring': PhosphorIconsBold.hurricane,
  'mane.resonance.measured_cuts': PhosphorIconsBold.metronome,
  'mane.resonance.rising_tempo': PhosphorIconsBold.trendUp,
  ...
  'pip.control.bank_shot': PhosphorIconsBold.arrowBendUpRight,
  'pip.control.split_decision': PhosphorIconsBold.arrowsSplit,
  'pip.control.trick_payload': PhosphorIconsBold.magicWand,
  'pip.control.no_safe_angle': PhosphorIconsBold.polygon,
  'pip.resonance.clean_volley': PhosphorIconsBold.checks,
  'pip.resonance.fast_hands': PhosphorIconsBold.lightning,
  'pip.resonance.cash_out': PhosphorIconsBold.coins,
  'pip.resonance.overflow': PhosphorIconsBold.arrowFatLinesUp,
  // Mask
